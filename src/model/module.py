...
class WindFlowDecoder(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_velocity_diff', velocity_diff, on_step=True, on_epoch=False, prog_bar=False)
        self.log('train_direction_diff', direction_diff, on_step=True, on_epoch=False, prog_bar=False)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        velocity_diff = compute_velocity_error(prediction, prediction_gt)
        direction_diff = compute_direction_error(prediction, prediction_gt)
        self.log('val_velocity_diff', velocity_diff, on_step=True, on_epoch=False, prog_bar=True)
        self.log('val_direction_diff', direction_diff, on_step=True, on_epoch=False, prog_bar=True)
